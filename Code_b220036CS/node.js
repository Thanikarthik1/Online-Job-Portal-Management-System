...
app.post('/signup', middle, async (req, resp) => {
    ...
    const d = await new model({ user_Id: count + 1, Designation: req.body.Designation, Name: req.body.name, Number: req.body.Number, Password: req.body.password ,email:req.body.email,Age:req.body.Age})
...
app.post('/employer', async (req, resp) => {
    ...
    if (check == null) {
        ...
        if (user1 == null) {
            ...
            const fd = await new model2({ user_Id: userId, Serial_Number: count + 1, Company: req.body.Company, email: req.body.Salary, Number: req.body.Registered_Number, Job_Name: req.body.Job_Name, Eligibility:req.body.Eligibility,Deadline:req.body.Deadline,Location:req.body.Location })
...
app.post('/aspirant', async (req, resp) => {
    ...
    if (check == null) {
        ...
        if (user1 == null) {
            ...
            const fd = await new model2({user_Id: userId, Serial_Number: count + 1, Company: req.body.Company, email: req.body.Salary, Number: req.body.Registered_Number, Job_Name: req.body.Job_Name,Qualification:req.body.Qualification,Location:req.body.Location,Name:req.body.Name})
            const data1 = await fd.save();
...
app.post('/EUpdate', async (req, resp) => {
    ...
    if (check == null) {
        ...
        // const user1 = await model2.findOne({ 'Job_Name': req.body.Registered_Number })
            ...
            const fd = await model2.updateOne({ 'Number': req.body.Registered_Number  },{$set :{ Company: req.body.Company, email: req.body.Salary, Job_Name: req.body.Job_Name, Eligibility:req.body.Eligibility,Deadline:req.body.Deadline,Location:req.body.Location}})
            // const data1 = await fd.save();
            const Employ = await model2.find();
...
app.post('/RUpdate', async (req, resp) => {
    ...
    if (check == null) {
        ...
        // const user1 = await model2.findOne({ 'Job_Name': req.body.Registered_Number })
            ...
            const fd = await model2.updateOne({ 'Number': req.body.Registered_Number  },{$set :{ Company: req.body.Company, email: req.body.Salary, Number: req.body.Registered_Number, Job_Name: req.body.Job_Name,Eligibility:req.body.Eligibility,Qualification:req.body.Qualification,Location:req.body.Location ,Age:req.body.Age,Name:req.body.Name}})
            // const data1 = await fd.save();
            const Employ = await model2.find();
